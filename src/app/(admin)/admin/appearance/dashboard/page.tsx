...
const defaultBlocks: Block[] = [
  ...
  { id: '2', name: 'Timeline', region: 'side-pre', visible: true },
  { id: '3', name: 'Calendar', region: 'side-pre', visible: true },
  { id: '4', name: 'Upcoming events', region: 'side-pre', visible: true },
  { id: '5', name: 'Recently accessed courses', region: 'content', visible: true },
  { id: '6', name: 'Starred courses', region: 'content', visible: true },
  { id: '7', name: 'Online users', region: 'side-pre', visible: true },
  { id: '8', name: 'Latest badges', region: 'side-pre', visible: false },
];
      ...
      <div id="page-content" className="p-4">
        <div id="region-main">
          <p className="text-sm text-[var(--text-muted)] mb-4">
            Configure the default blocks and layout for the Dashboard page. This layout will be applied to all users who have not customised their Dashboard. Changes here will not affect users who have already customised their Dashboard.
          </p>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            >
              <RotateCcw size={14} /> Reset Dashboard for all users
            </button>
          </div>
