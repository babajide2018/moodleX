      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            <Link href="/admin/users/add" className="btn btn-primary text-sm flex items-center gap-1">
              <UserPlus size={16} /> Add a new user
            </Link>
            <Link href="/admin/users/upload" className="btn btn-secondary text-sm flex items-center gap-1">
