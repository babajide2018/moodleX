...
export default function OverviewReportSettingsPage() {
  return (
    <>
      <PageHeader
        title="Overview report settings"
        breadcrumbs={[
      ...
      <div id="page-content" className="p-4">
        <div id="region-main">
          <form className="max-w-3xl space-y-4">
            <SettingsSection title="Overview report settings">
              <SettingField label="Show rank" help="Display the student&apos;s position relative to the rest of the class for each grade item.">
