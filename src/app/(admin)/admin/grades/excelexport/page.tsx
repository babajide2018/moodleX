...
export default function ExcelExportSettingsPage() {
  return (
    <>
      <PageHeader
      ...
      <div id="page-content" className="p-4">
        <div id="region-main">
          <form className="max-w-3xl space-y-4">
            <SettingsSection title="Excel export settings">
              <SettingField label="Include feedback" help="Include grade feedback in the exported Excel file.">
            ...
            <SettingsSection title="Display types" defaultOpen={false}>
