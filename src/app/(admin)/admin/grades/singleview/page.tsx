      ...
      <div id="page-content" className="p-4">
        <div id="region-main">
          <form className="max-w-3xl space-y-4">
            <SettingsSection title="Single view settings">
              <SettingField label="Enable single view" help="Allow teachers to view and edit grades for a single user or a single grade item at a time.">
              ...
              <SettingField label="Show quick feedback" help="Show a feedback text input alongside each grade in the single view.">
                <select className="form-control text-sm">
                  <option value="0">No</option>
                  <option value="1">Yes</option>
                </select>
              ...
              <SettingField label="Students per page" help="Number of students to display per page in the single view for a grade item.">
