...
export default function XMLExportSettingsPage() {
  return (
    <>
      <PageHeader
        title="XML export settings"
        breadcrumbs={[
      ...
      <div id="page-content" className="p-4">
        <div id="region-main">
          <form className="max-w-3xl space-y-4">
            <SettingsSection title="XML export settings">
              <SettingField label="Include feedback" help="Include grade feedback in the exported XML file.">
