...
export default function CSVExportSettingsPage() {
  return (
    <>
      <PageHeader
        ...
        <div id="region-main">
          <form className="max-w-3xl space-y-4">
            <SettingsSection title="CSV export settings">
              <SettingField label="Separator" help="The character used to separate fields in the exported CSV file.">
              ...
              <SettingField label="Include feedback" help="Include grade feedback in the exported file.">
                <select className="form-control text-sm">
            ...
            <SettingsSection title="Grade display" defaultOpen={false}>
              <SettingField label="Export real grades" help="Include real (numeric) grades in the export.">
                <select className="form-control text-sm">
                  <option value="1">Yes</option>
                  <option value="0">No</option>
                </select>
              ...
              <SettingField label="Export percentages" help="Include percentage grades in the export.">
                <select className="form-control text-sm">
                  <option value="1">Yes</option>
                  <option value="0">No</option>
                </select>
              ...
              <SettingField label="Export letter grades" help="Include letter grades in the export.">
                <select className="form-control text-sm">
                  <option value="0">No</option>
                  <option value="1">Yes</option>
                </select>
              ...
              <SettingField label="Decimal points" help="Number of decimal points in exported grades.">
                <select className="form-control text-sm">
